...
void Game::buildTileset() {
	...
	for (int i = 0; i < maxTilesetSize; i++) {
		tileClips[i] = { { tcx, tcy, TILE_SIZE, TILE_SIZE }, { false, true, false, false } };
		tcx += TILE_SIZE;
...
void Game::buildTiles(string path) {
	...
	int y = 0, x = 0;
	for (int i; RAF >> i;) {
		tiles.push_back(Tile(x, y, &tileClips[i].first, get<0>(tileClips[i].second), get<1>(tileClips[i].second), get<2>(tileClips[i].second), get<3>(tileClips[i].second), &dynamicMap["tileset"]));
		x += TILE_SIZE;
		if (RAF.peek() == '\n') {
			y += TILE_SIZE;
			mapMaxX += x;
	...
	for (int y = 0; y < indexMaxY; y++) {
		...
		for (int x = 0; x < indexMaxX; x++) {
			...
			if (tiles[x + yIndex].getHasInner()) {
				...
				if (!tiles[x + ym1].getHasInner() && !tiles[(x - 1) + yIndex].getHasInner() && !tiles[(x + 1) + yIndex].getHasInner() && !tiles[x + yp1].getHasInner())
				...
				if (!tiles[(x - 1) + ym1].getHasInner() && tiles[x + ym1].getHasInner() && !tiles[(x + 1) + ym1].getHasInner() && tiles[(x - 1) + yIndex].getHasInner() && tiles[(x + 1) + yIndex].getHasInner() && !tiles[(x - 1) + yp1].getHasInner() && tiles[x + yp1].getHasInner() && !tiles[(x + 1) + yp1].getHasInner())
				...
				if (!tiles[(x - 1) + ym1].getHasInner() && tiles[x + ym1].getHasInner() && !tiles[(x + 1) + ym1].getHasInner() && tiles[(x - 1) + yIndex].getHasInner() && tiles[(x + 1) + yIndex].getHasInner() && !tiles[x + yp1].getHasInner())
					tiles[x + yIndex].shader = Shader(x * TILE_SIZE, y * TILE_SIZE, &shaderClips[18], &dynamicMap["shaders"]);
				//Tile left, right, and down
				if (!tiles[x + ym1].getHasInner() && tiles[(x - 1) + yIndex].getHasInner() && tiles[(x + 1) + yIndex].getHasInner() && !tiles[(x - 1) + yp1].getHasInner() && tiles[x + yp1].getHasInner() && !tiles[(x + 1) + yp1].getHasInner())
					tiles[x + yIndex].shader = Shader(x * TILE_SIZE, y * TILE_SIZE, &shaderClips[21], &dynamicMap["shaders"]);
				//Tile up, right, and down
				if (tiles[x + ym1].getHasInner() && !tiles[(x + 1) + ym1].getHasInner() && !tiles[(x - 1) + yIndex].getHasInner() && tiles[(x + 1) + yIndex].getHasInner() && tiles[x + yp1].getHasInner() && !tiles[(x + 1) + yp1].getHasInner())
					tiles[x + yIndex].shader = Shader(x * TILE_SIZE, y * TILE_SIZE, &shaderClips[19], &dynamicMap["shaders"]);
				//Tile up, left, and down
				if (!tiles[(x - 1) + ym1].getHasInner() && tiles[x + ym1].getHasInner() && tiles[(x - 1) + yIndex].getHasInner() && !tiles[(x + 1) + yIndex].getHasInner() && !tiles[(x - 1) + yp1].getHasInner() && tiles[x + yp1].getHasInner())
				...
				if (!tiles[x + ym1].getHasInner() && !tiles[(x - 1) + yIndex].getHasInner() && tiles[(x + 1) + yIndex].getHasInner() && tiles[x + yp1].getHasInner() && tiles[(x + 1) + yp1].getHasInner())
					tiles[x + yIndex].shader = Shader(x * TILE_SIZE, y * TILE_SIZE, &shaderClips[22], &dynamicMap["shaders"]);
				//Tile to the top, right, top-right
				if (tiles[x + ym1].getHasInner() && tiles[(x + 1) + ym1].getHasInner() && !tiles[(x - 1) + yIndex].getHasInner() && tiles[(x + 1) + yIndex].getHasInner() && !tiles[x + yp1].getHasInner())
				...
				if (!tiles[x + ym1].getHasInner() && tiles[(x - 1) + yIndex].getHasInner() && !tiles[(x + 1) + yIndex].getHasInner() && tiles[(x - 1) + yp1].getHasInner() && tiles[x + yp1].getHasInner())
				...
				if (tiles[(x - 1) + ym1].getHasInner() && tiles[x + ym1].getHasInner() && tiles[(x - 1) + yIndex].getHasInner() && !tiles[(x + 1) + yIndex].getHasInner() && !tiles[x + yp1].getHasInner())
				...
				/*
				//Template
				if (!tiles[(x - 1) + ym1].getHasInner() && !tiles[x + ym1].getHasInner() && !tiles[(x + 1) + ym1].getHasInner()
					&& !tiles[(x - 1) + yIndex].getHasInner() && !tiles[(x + 1) + yIndex].getHasInner()
					&& !tiles[(x - 1) + yp1].getHasInner() && !tiles[x + yp1].getHasInner() && !tiles[(x + 1) + yp1].getHasInner())
					tiles[x + yIndex].shader = Shader(x * TILE_SIZE, y * TILE_SIZE, &shaderClips[8], &dynamicMap["shaders"]);
				*/
			}
		}
